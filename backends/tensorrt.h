...
private:
    ...
    bool tokenize_and_accumulate_message(Message& msg);

    /// @brief Format system message with tools based on model family
    ...
    std::string generate_internal(const Session& session, int max_tokens);
