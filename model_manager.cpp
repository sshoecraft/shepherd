...
ModelConfig ModelManager::detect_from_chat_template(const std::string& template_text,
...
ModelConfig ModelManager::detect_from_model_path(const std::string& model_path) {
    return detect_from_path_analysis(model_path);
}

ModelConfig ModelManager::detect_from_model_name(const std::string& model_name) {
...
ModelConfig ModelManager::detect_from_template_content(const std::string& template_text,
                                                        const std::string& model_path) {
...
ModelConfig ModelManager::detect_from_path_analysis(const std::string& model_path) {
    if (model_path.empty()) {
...
std::string ModelManager::extract_version_from_path(const std::string& model_path,
...
std::string ModelManager::format_system_message(const ModelConfig& config,
